...
#include "convolutional_layer_sparse_matrix.h"
...
Network* construct_cifar_net() {
  ...
  conv_load(net->layers[0], layer1_conv_params, layer1_conv_data, "../Redundant-Matrices/models/cifar/conv1_sparse");
  conv_load(net->layers[3], layer4_conv_params, layer4_conv_data, "../Redundant-Matrices/models/cifar/conv2_sparse");
  conv_load(net->layers[6], layer7_conv_params, layer7_conv_data, "../Redundant-Matrices/models/cifar/conv3_sparse");
